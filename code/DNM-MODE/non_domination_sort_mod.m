function [population, fitness, rank_distance] = non_domination_sort_mod(population, fitness, M, V)

x=[population, fitness];
[N, ~] = size(x);
clear m
...
for front = 1 : (length(F) - 1)
    ...
    % Sort each individual based on the objective value
